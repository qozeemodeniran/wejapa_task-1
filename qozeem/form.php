...
<section class="half">
    <div>          
    <?php
    if(isset($_POST['submit']) && (!empty($_POST['name']) && (!empty($_POST['email']) && (!empty($_POST['stack']))))){
        ...
        echo "<p id='warn'>You omitted important field(s) while filling the form. Kindly revisit form.</p>";
    }
    ?> 
    </div>
</section>
